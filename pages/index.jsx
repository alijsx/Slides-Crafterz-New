...
const Index = () => {
  return (
    <Layout footer={6} dark>
            ...
            <div className="row no-gap">
              ...
              <div className="col-xl-4">
                <div className="hero-six-content">
                  ...
                  <p>
                    Welcome to Slides crafterz! We transform messages into captivating PowerPoint presentations, unlocking the power of persuasion for professionals and students alike. With custom-tailored designs, we guarantee an impressive and lasting impact. Elevate your narrative effortlessly with Slide Crafterz, where each slide tells a compelling story
                  </p>
      ...
      <div className="client-logo-area pt-90 rpb-70 rel z-1">
        <div  className="container">
          <div className="row">
